...
베이스 URL: `https://chofam-home.web.app/api/mail` (Hosting rewrite를 통해 Functions로 연결)
...
3. 시크릿 등록:
   ...
   # MAIL_API_KEYS 값 예시: {"<liv-ay-key>":"liv-ay","<admin-key>":"chofam-admin"}
   ```
